##Swirl Lesson 9: Function
Sys.Date() ## returns the current date
mean() ## takes a vector of numbers as an input and returns the mean
...
remainder <- function(num, divisor=2) {
        num %% divisor# Write your code here! 
...
##This exercise was a lot easier than it seemed at first
evaluate(sd,c(1.4, 3.6, 7.9, 8.8))
##And this one I really got on my own
evaluate(function(x){x[1]}, c(8, 4, 0)) #returns the first value of the data set specified
evaluate(function(x){x[length(x)]}, c(8, 4, 0)) #returns the last value of the data set specified